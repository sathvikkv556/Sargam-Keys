      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <div className="pt-6">
              <Button asChild size="lg" className="h-14 px-8 rounded-full bg-blue-600 hover:bg-blue-700 text-lg group">
                <Link href="/music-theory" className="flex items-center gap-2">
                  Start Learning Now
          ...
          >
            ...
            <div className="relative z-10 w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-slate-900 to-blue-900 flex items-center justify-center p-8">
